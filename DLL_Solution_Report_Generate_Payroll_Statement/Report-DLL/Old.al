report 70000 "Generate Payroll Statement DLL"
{
    ...
    local procedure CreatePayrollStatementEmployees(EmployeeCode: Code[20];
                                                    VAR RecPayrollStatement_P: Record "Payroll Statement");
    var
    ...
    begin
        ...
        // Stop @BC DLL
        // Start 15.06.2020
        AdvacnePayrollSetupG.Reset();
        if AdvacnePayrollSetupG.Get() then;
        // Stop 15.06.2020
        //22.10.2020
        RecPayrollStatement.RESET;
        RecPayrollStatement.SetCurrentKey("Payroll Statement ID");
        //22.10.2020
        RecPayrollStatement.SetRange("Payroll Statement ID", RecPayrollStatement_P."Payroll Statement ID");
        if RecPayrollStatement.FindFirst() then begin
