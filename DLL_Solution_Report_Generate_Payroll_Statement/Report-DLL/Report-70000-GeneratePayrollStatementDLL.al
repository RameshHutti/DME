report 70001 "Generate Payroll Statement DL2"
{
    // version LT_Payroll
    ...
    var
        ...
        RecPayrollStatement2: Record "Payroll Statement";
    begin
        // Start  @BC DLL 
        ...
        // Stop 15.06.2020
        RecPayrollStatement2 := RecPayrollStatement;
        RecPayrollStatement.Reset();
        RecPayrollStatement.SetRange("Payroll Statement ID", RecPayrollStatement2."Payroll Statement ID");
        if RecPayrollStatement.FindFirst() then begin
            ...
            */
            ...
            @ Stop 23.04.2020
            */
            // until RecPayrollStatement.Next() = 0; ------------------> first wala loop
        end;
    ...
    begin
        ...
        if _RecPayrollStatement.FindSet() then begin
            repeat
                _RecPayrollStatementEmployee.Reset();
                if _RecPayrollStatementEmployee.FindSet() then begin
                    repeat
