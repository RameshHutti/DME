table 60000 "Advance Payroll Setup"
{
    ...
    fields
    {
        ...
        //08.10.2020
        field(50150; "Positng Type"; Option)
        {
            OptionMembers = Individual,Consolidated;
        }
        field(50151; "Consolidated Dimension"; Code[20])
        {
            TableRelation = Dimension;
        }
        //08.10.2020
        //28.10.2020
        field(50152; "F and F Vendor Posting"; Boolean)
        {
