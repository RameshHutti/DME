page 60042 "Payroll Earning Code Wrkr"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = All;
                    Editable = BlankBool1G;//Rec."Earning Code" = '';
                }
                field("Short Name"; Rec."Short Name")
                {
                    ApplicationArea = All;
                    Editable = BlankBool2G;//Rec."Short Name" = '';
                }
            ...
            group("Adavanced Setup")
            {
                ...
                field("Leave Encashment Enable"; "Leave Encashment Enable")
                {
                    ApplicationArea = All;
                }
            }
    ...
    begin
        ...
        // EarningCGRecL.Reset();
        // EarningCGRecL.SetRange("Employee Code", Rec.Worker);
        // EarningCGRecL.SetRange("Valid To", 0D);
        // if EarningCGRecL.FindFirst() then begin
        //     Message('%1', EarningCGRecL."Earning Code Group");
        //     Rec.Validate("Earning Code Group", EarningCGRecL."Earning Code Group");
        //     Commit();
        // end;
    end;
