page 60084 "Payroll Statements"
{
    ...
    actions
    {
        area(processing)
        {
                ...
                action("Submit For Approval")
                {
                    ...
                    begin
                        ...
                        if PayrollStatement.FINDFIRST then begin
                            ...
                            wfcode.CheckWorkflowEnabled(Rec);//Krishna
                            wfcode.OnSendPayrollStat_Approval(Rec);//Krishna
                        end;
                        CurrPage.UPDATE;
                    end;
                }
            ...
            action(Reopen)
            {
                Enabled = WFReopenBoolG;//Rec."Workflow Status" = Rec."Workflow Status"::Approved;
                Image = ReOpen;
                Promoted = true;
                PromotedCategory = Process;
                PromotedOnly = true;
            ...
            {
                Enabled = WFApprovedBoolG;//Rec."Workflow Status" = Rec."Workflow Status"::Approved;
                Image = Confirm;
                Promoted = true;
                PromotedOnly = true;
                PromotedCategory = Process;
            ...
            action("Enable Payslip")
            {
                ...
                begin
                    ...
                    PayPeriod.RESET;
                    PayPeriod.SETRANGE("Pay Cycle", Rec."Pay Cycle");
                    PayPeriod.SetRange("Period Start Date", "Pay Period Start Date");
                    if PayPeriod.FindFirst() then begin
                        PayPeriod."Enable Payroll Statements" := true;
                        PayPeriod.Modify();
