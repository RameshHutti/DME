        ...
        dataitem("Full and Final Calculation"; "Full and Final Calculation")
        {
            ...
            dataitem("FS - Earning Code"; "FS - Earning Code")
            {
                ...
                begin
                    ...
                    // LastDate := CALCDATE('CM', "Full and Final Calculation"."Termination Date");
                    // FirstDate := CALCDATE('-CM', "Full and Final Calculation"."Termination Date");
                    // FsReaningCodeRec3L.Reset();
                    // FsReaningCodeRec3L.SetCurrentKey("Pay Period Start");
                    // FsReaningCodeRec3L.SetRange("Journal ID", "Journal ID");
                    // FsReaningCodeRec3L.SetRange("Employee No.", "Employee No.");
                    // FsReaningCodeRec3L.SetFilter("Pay Period Start", '%1..%2', FirstDate, LastDate);
                    // if FsReaningCodeRec3L.FindLast() then begin
                    //     Clear(StartEndCountG);
                    //     Message('if END  %1---- Start  %2', "Full and Final Calculation"."Termination Date", "Pay Period Start");
                    //     StartEndCountG := ("Full and Final Calculation"."Termination Date" - "Pay Period Start") + 1;
                    // end else begin
                    //     Message('else END  %1---- Start  %2', "Pay Period End", "Pay Period Start");
                    //     Clear(StartEndCountG);
            ...
            // Start Trigger Full and Final Calculation
            trigger OnAfterGetRecord();
            begin
            ...
            // Stop Trigger Full and Final Calculation
        }
    }
    trigger OnPreReport();
    begin
