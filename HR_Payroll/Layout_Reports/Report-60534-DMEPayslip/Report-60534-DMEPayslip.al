report 60534 "DME Payslip"
{
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            dataitem(PayrollStatementLines; "Payroll Statement Lines")
            {
                ...
                // Start "Payroll Statement Lines" Triger
                ...
                // Stop "Payroll Statement Lines" Triger
    ...
    begin
        PayPeriodCode := PayPeriodCode_P;//PayPeriod.Month + ' ' + FORMAT(PayPeriod.Year);
        PayMonth := PayMonth_P;//PayPeriod.Month;
        PayYear := PayYear_P;//PayPeriod.Year;
        PeriodStartDateG := PeriodStartDateG_P;//PayPeriod."Period Start Date";
