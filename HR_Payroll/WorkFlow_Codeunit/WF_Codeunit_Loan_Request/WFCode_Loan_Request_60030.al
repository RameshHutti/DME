codeunit 60030 WFCode_Loan_Request
{
    ...
    var
        ...
        WorkflowStepArgumentG: Record "Workflow Step Argument";
        ...
        case RecRef.Number() of
            ...
            DATABASE::"Loan Request":
                begin
                    ...
                    // Message('Test Loan %1 NotificationUserID %2  WorkflowStepArgumentG  %3  As per AppEntry %4',
                    // loanReqRec."Loan Request ID",
                    // WorkflowStepArgumentG.GetNotificationUserID(ApprovalEntry2),
                    // WorkflowStepArgumentG.ID,
                    // ApprovalEntry2."Sender ID");
                end;
        end;
    end;
        ...
        IF WorkflowResponse.GET(ResponseWorkflowStepInstance."Function Name") THEN
            case WorkflowResponse."Function Name" of
                ...
                Release_Loan_RequestCode():
                    begin
                        Clear(WorkflowStepArgumentG);
                        WorkflowStepArgumentG.Get(ResponseWorkflowStepInstance.Argument);
                        Release_Loan_Request(Variant);
                        ResponseExecuted := true;
                    end;
